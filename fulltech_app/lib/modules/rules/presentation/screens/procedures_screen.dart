...
class _ProceduresScreenState extends ConsumerState<ProceduresScreen> {
  ...
  RulesCategory? _category = RulesCategory.procedure;
  String? _roleFilter;
  bool? _activeFilter;
  ...
  Future<void> _create() async {
    final draft = await showDialog<RulesContent>(
      ...
      builder: (_) => const RuleEditorDialog(
        ...
        allowedCategories: [RulesCategory.procedure, RulesCategory.general],
      ),
    );
                ...
                children: [
                  ...
                  OutlinedButton.icon(
                    onPressed: () {
                      setState(() {
                        _searchCtrl.clear();
                        _category = RulesCategory.procedure;
                        _roleFilter = null;
                        _activeFilter = null;
                      });
                    },
            ...
            child: asyncPage.when(
              ...
              error: (e, _) => Center(
                child: Column(
                  ...
                  children: [
                    const Text('No se pudieron cargar los procedimientos'),
